...
メールアドレスは，招待メールの受取に用いたメールアドレスを入力してください．
また，メールアドレスは，チャンネル選択画面のユーザ情報編集ボタンから編集できます．

<img src="./image/email.png" width="400px">

### 2. チャンネル設定
チャンネル選択画面の設定ボタンを押して，設定画面へ移動してください．
「お住いの地域」にて，**「東京」**を選択してください．
...
アンケートのリンク: https://goo.gl/forms/02YTn7TRB1708QID3

## 視聴していただく番組の詳細
予定している番組の詳細を以下のリンクにまとめました．
Googleスプレッドシートなので，ダウンロードして時間計算等にご活用ください．

番組詳細: https://docs.google.com/spreadsheets/d/11B8V6kIKAQ_TbQz85StICOkmj6TDNsazNh8TbTqcQ2w/edit?usp=sharing
